          ...
          <div className="flex-1 space-y-4">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                ></div>
                <h2 className="text-2xl font-semibold" style={{ color: riskColor }}>
                  {riskLevel}
                </h2>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
              <div className="bg-white/5 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                ...
                <p className="text-2xl font-semibold text-white">{metrics.activeTasks}</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                <p className="text-sm text-gray-400">Overdue Tasks</p>
                <p className="text-2xl font-semibold" style={{ color: 'var(--neon-red, #ef4444)' }}>{metrics.overdueTasks}</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                <p className="text-sm text-gray-400">Completed Tasks</p>
                <p className="text-2xl font-semibold" style={{ color: 'var(--neon-green)' }}>{metrics.completedTasks}</p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm p-3 rounded-lg border border-white/10">
                <p className="text-sm text-gray-400">Recent Feedback</p>
                <p className="text-2xl font-semibold" style={{ color: 'var(--neon-blue)' }}>{metrics.recentFeedback}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="ml-4 text-right">
                    ...
                    <p className="text-2xl font-bold text-red-400">-{risk.impact}</p>
                  </div>
                </div>
              </div>
            ))}
